...
public class InputActivity extends ListActivity implements OnScrollListener
{
	...
	submitButton.setOnClickListener(new OnClickListener()
	{
		...
		ConnectivityManager cm = (ConnectivityManager) InputActivity.this
		...
		if (!isGPSEnabled || !isInternetConnected)
		{
		    Toast.makeText(InputActivity.this,
			    "Please check your GPS/Network settings",
		...
		{
		    Toast.makeText(InputActivity.this, "Too many queries",
			    Toast.LENGTH_SHORT).show();
		    return;
		}

		Intent nextAct = new Intent(InputActivity.this,
			MapActivity.class);
	...
	addItemButton.setOnClickListener(new OnClickListener()
	{
	    public void onClick(View view)
	    {
		final EditText addItemEditText = new EditText(
			InputActivity.this);
		...
		new AlertDialog.Builder(InputActivity.this)
			...
			.setMessage(
				"Enter in the location/task you need to complete:")
			...
			.setPositiveButton("Add",
				new DialogInterface.OnClickListener()
				{
				    public void onClick(DialogInterface dialog,
					    int whichButton)
				    {
					addItem(addItemEditText.getText()
						.toString());
				    }
				})
	...
	findViewById(R.id.editButton).setVisibility(
		listView.getChildCount() > 0 ? View.VISIBLE : View.INVISIBLE);
	findViewById(R.id.clearAllButton).setVisibility(
		editModeEnabled ? View.VISIBLE : View.GONE);
	findViewById(R.id.submitButton).setVisibility(
		editModeEnabled ? View.GONE : View.VISIBLE);
    }
	...
	{
	    Toast.makeText(InputActivity.this, "Query too long",
		    Toast.LENGTH_SHORT).show();
	    return;
	}
    ...
    private DragSortListView.RemoveListener onRemove = new com.mobeta.android.dslv.DragSortListView.RemoveListener()
    {
